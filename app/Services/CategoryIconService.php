...
class CategoryIconService
{
    ...
    private const RULES = [
        ...
        ['keys' => ['beras'], 'emoji' => '🍚'],
        ['keys' => ['bumbu', 'rempah'], 'emoji' => '🌶️'],
        ['keys' => ['gula jawa', 'gula pasir', 'gula '], 'emoji' => '🫙'],
        ['keys' => ['bahan pembuat'], 'emoji' => '🥣'],
        ['keys' => ['bahan makanan', 'sembako', 'mie', 'tepung', 'minyak'], 'emoji' => '🥘'],
        ['keys' => ['instan food', 'instan'], 'emoji' => '🍜'],
        ['keys' => ['buah buahan', 'buah '], 'emoji' => '🍎'],
        ['keys' => ['minuman', 'soda', 'jus', 'teh'], 'emoji' => '🥤'],
        ['keys' => ['kopi'], 'emoji' => '☕'],
        ['keys' => ['snack', 'keripik', 'kerupuk', 'biskuit', 'coklat', 'permen', 'camilan'], 'emoji' => '🍿'],
        ['keys' => ['sabun', 'deterjen', 'det bubuk', 'det cair', 'cuci', 'pembersih', 'kebersihan', 'detergen dapur'], 'emoji' => '🫧'],
        ['keys' => ['bodycare', 'kosmetik', 'shampo', 'skincare'], 'emoji' => '💄'],
        ['keys' => ['susu', 'yogurt', 'keju', 'dairy'], 'emoji' => '🥛'],
        ['keys' => ['daging', 'ayam', 'ikan', 'seafood', 'dag'], 'emoji' => '🥩'],
